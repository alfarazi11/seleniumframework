...
public class MyScreenRecorder extends ScreenRecorder {
    ...
    public MyScreenRecorder(GraphicsConfiguration cfg, Rectangle captureArea, Format fileFormat,
                            Format screenFormat, Format mouseFormat, Format audioFormat, File movieFolder, ITestResult name)
    ...
    public static void startRecording(ITestResult result) throws Exception {
